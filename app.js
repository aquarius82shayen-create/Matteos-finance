...
function monthInsightButtons(){
  ...
  if(!months.length){
    return `<button class="big-btn income month-insight-btn" disabled>Mese migliore</button><button class="big-btn expense month-insight-btn" disabled>Mese peggiore</button>`;
  }
