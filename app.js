...
function openForecastMonthPicker(){openFinanceChoice('Mese di riferimento',monthOptions(),state.forecastMonth,m=>{state.forecastMonth=m;save();render();requestAnimationFrame(()=>window.scrollTo({top:0,left:0,behavior:'auto'}))})}
