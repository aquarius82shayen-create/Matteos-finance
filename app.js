...
function dashboardWeekDays(){
  ...
  start.setDate(start.getDate()+dashboardWeekOffset*7);
...
function shiftDashboardWeek(delta){dashboardWeekOffset+=delta;render()}
...
return `<section class="page ${state.page==='dashboard'?'active':''}">
  <div class="hero">
    <img class="duck-art" src="assets/duck-hero.png" alt="" />
    <div class="brand" aria-label="Matteo's Finance"><span class="matteo">MATTEO'S</span><span class="finance">FINANCE</span></div>
...
function goalVisual(name){
  ...
  // Destinazioni specifiche prima della categoria generica "vacanza".
