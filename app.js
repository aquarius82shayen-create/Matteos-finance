...
function monthInsightButtons(){
  ...
  if(months.length<2){
    ...
    return `<button class="big-btn insight-locked" disabled>Disponibile tra</button><button class="big-btn insight-locked" disabled>${days} giorni</button>`;
  }
  ...
  return `<button class="big-btn income insight-ready" onclick="openMonthAnalysis('${best.m}')">Mese migliore</button><button class="big-btn expense insight-ready" onclick="openMonthAnalysis('${worst.m}')">Mese peggiore</button>`;
}
