...
function semanticIconFile(description='',category='',type=''){
  ...
  const position=(v)=>{const p=normalize(v),i=text.indexOf(p);if(i>=0)return i;const c=compact(v),j=compact(text).indexOf(c);return j>=0?j:Infinity;};
